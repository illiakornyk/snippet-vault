    ...
    >
      <div>
        <div className="flex items-start justify-between mb-2">
          <h3
            className="font-semibold text-lg line-clamp-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors"
            title={snippet.title}
          >
            {snippet.title}
          </h3>
          <div className="flex flex-col items-end shrink-0 ml-2">
            <span
              className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${typeClasses}`}
            >
              {snippet.type}
            </span>
